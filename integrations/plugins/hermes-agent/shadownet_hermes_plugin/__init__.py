...
_PLATFORM_HINT = (
    ...
    "mcp_shadownet_send to message one (set body.intent to a "
    "urn:shadownet:intent:*_v1 URI for typed coordination — RFC 0002 §3 "
    "is content-agnostic), mcp_shadownet_respond to continue a thread by "
    "contextId, and mcp_shadownet_inbox / mcp_shadownet_inbox_wait for "
    "inbox triage. Slash commands: /shadownet-setup, /shadownet-inbox, "
